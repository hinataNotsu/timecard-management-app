      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <button onClick={() => router.push('/company/members')} className="w-full px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition">
              スタッフ一覧
            </button>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <button onClick={() => router.push('/company/shifts')} className="w-full px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 transition">
              シフトを見る
            </button>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <button onClick={() => router.push('/company/payroll')} className="w-full px-4 py-2 bg-purple-600 text-white rounded-md hover:bg-purple-700 transition">
              給与計算
            </button>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <button onClick={() => router.push('/company/timecard-management')} className="w-full px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 transition">
              記録を見る
            </button>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <button onClick={() => router.push('/company/report')} className="w-full px-4 py-2 bg-orange-600 text-white rounded-md hover:bg-orange-700 transition">
              レポート
            </button>
          </div>
          ...
          {organization?.isWatchAdmin === true && (
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <button onClick={() => router.push('/company/timecards/users')} className="w-full px-4 py-2 bg-teal-600 text-white rounded-md hover:bg-teal-700 transition">
                管理する
              </button>
            </div>
          )}
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <button onClick={() => router.push('/company/settings')} className="w-full px-4 py-2 bg-gray-600 text-white rounded-md hover:bg-gray-700 transition">
              設定
            </button>
          </div>
        </div>
